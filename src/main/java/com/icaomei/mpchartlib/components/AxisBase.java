...
package com.icaomei.mpchartlib.components;
...
public abstract class AxisBase extends ComponentBase {
    ...
    protected boolean mDrawTopLabels = true;
    ...
    public void setDrawTopLabels(boolean enabled) {
    	mDrawTopLabels = enabled;
    }
     ...
     * @return
     */
    public boolean isDrawTopLabelsEnabled() {
        return mDrawTopLabels;
    }
