...
import com.icaomei.mpchartlib.buffer.BarBuffer;
...
//                        buffer.buffer[j + 3], mRenderPaint);
                float tempwith=0;
                if(entries.size()>3){
                	tempwith=5*(buffer.buffer[j+2]-buffer.buffer[j])/16;
                }else{
                	tempwith=3*(buffer.buffer[j+2]-buffer.buffer[j])/8;
                }
                c.drawRect(buffer.buffer[j]+tempwith, buffer.buffer[j + 1], buffer.buffer[j+2]-tempwith,
                        buffer.buffer[j + 3], mRenderPaint);
            }
        } else {
