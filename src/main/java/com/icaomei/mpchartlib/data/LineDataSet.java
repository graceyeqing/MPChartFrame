...
package com.icaomei.mpchartlib.data;
...
public class LineDataSet extends LineRadarDataSet<Entry> {
	...
	/**
	 * @return the mDrawValue
	 */
	public boolean ismDrawValue() {
		return mDrawValue;
	}

	/**
	 * @param mDrawValue the mDrawValue to set
	 */
	public void setmDrawValue(boolean mDrawValue) {
